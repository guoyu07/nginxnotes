...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] Nginx}\\[2\baselineskip] % Title
{\large \textit{Nginx}}\\[4\baselineskip] % Tagline or further description
